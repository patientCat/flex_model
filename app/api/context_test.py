...
class TestTestContextHolder(unittest.TestCase):
    ...
    def test_model_context(self):
        model_context = self.test_context_holder.model_context()
    ...
    def test_database_info(self):
        model_context = self.test_context_holder.model_context()
        database_info = self.test_context_holder.database_info(model_context)
    ...
    def test_database_info_not_exist(self):
        with self.assertRaises(BizException) as context:
            self.test_context_holder.database_info(ModelContext.create_from_schema({}))
