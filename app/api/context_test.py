...
class TestTestContextHolder(unittest.TestCase):
    ...
    def test_model_context(self):
        ...
        self.assertEqual(model_context.__model_name_ctx.name, TestContextHolder.example_schema.get("x-model-name"))
    ...
    def test_database_info(self):
        ...
        self.assertEqual(database_info.database_name, model_context.__database_identity.database_name)
